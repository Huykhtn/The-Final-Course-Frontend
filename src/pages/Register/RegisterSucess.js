        ...
        <div className="flex items-center justify-center h-screen">
            <div>
                <div className="flex flex-col items-center space-y-2">
                    ...
                    <h1 className="text-4xl font-bold">Đăng Ký thành công !</h1>
                    <p>Cảm ơn bạn đã đăng ký dịch vụ của chúng tôi.. Vui lòng đợi trong giây lát chúng tôi gửi tới email cho bạn.</p>
